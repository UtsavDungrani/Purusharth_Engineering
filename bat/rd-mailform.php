...
try {
    ...
    // Set From to user's email
    if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
        $mail->From = $_POST['email'];
    } else {
        $mail->From = $formConfig['username']; // fallback
    }
    $mail->FromName = (isset($_POST['first_name']) ? $_POST['first_name'] : '') . ' ' . (isset($_POST['last_name']) ? $_POST['last_name'] : '');

    // Set recipient to fixed email
    $mail->clearAddresses();
    $mail->addAddress('utsavdungrani7@gmail.com');
